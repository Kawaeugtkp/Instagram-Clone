...
class NotificationCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        addSubview(profileImageView)//こっちにはcontentviewないけど、profileImageViewについては視覚的に存在していることがわかればよくて、それ自身をタップしてどうこうすることがないからcontentviewがいらない
        profileImageView.setDimensions(height: 48, width: 48)
        profileImageView.layer.cornerRadius = 48 / 2
        profileImageView.centerY(inView: self, leftAnchor: leftAnchor, paddingLeft: 12)
        
        contentView.addSubview(followButton)//contentViewがなかったらセルの上にこれらのviewが乗るんじゃなくて下に重なっていくことになるから、タップしたときにdidselectrowatが優先される
