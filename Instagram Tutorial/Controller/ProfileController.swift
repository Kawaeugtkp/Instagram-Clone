...
private let cellIdentifiler = "ProfileCell"
...
class ProfileController: UICollectionViewController {
    ...
    func configureCollectionView() {
        ...
        collectionView.register(ProfileCell.self, forCellWithReuseIdentifier: cellIdentifiler)
...
extension ProfileController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellIdentifiler, for: indexPath) as! ProfileCell
...
extension ProfileController: UICollectionViewDelegateFlowLayout {
    ...
    //minimumspacing系のこの二つの関数はセルの間の距離を返す関数らしい。だから現状は1になっている。
